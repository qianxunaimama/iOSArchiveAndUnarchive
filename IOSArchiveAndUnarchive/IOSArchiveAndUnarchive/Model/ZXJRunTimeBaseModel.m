...
+ (NSString *)getThefilePath
{
    ...
    NSString *Path = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory,
                                                           NSUserDomainMask, YES)firstObject]stringByAppendingPathComponent:selfClassName];
    return Path;
}
...
//    
//    NSString *selfClassName = NSStringFromClass([self class]);
//    NSString *Path = [[NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES)firstObject]stringByAppendingString:selfClassName];
//    return Path;
//}
//
//+ (NSArray *)propertyOfSelf{
